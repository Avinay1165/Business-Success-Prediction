...
def viz(m, d, l, n, c):
    ...
    output_df.loc[
        output_df['mean_prob_companies_acquired_by_state'].isnull(), 'mean_prob_companies_acquired_by_state'] = 0
    output_df.loc[
        output_df['count_prob_companies_acquired_by_state'].isnull(), 'count_prob_companies_acquired_by_state'] = 0
    output_df.loc[
        output_df['count_prob_companies_closed_by_state'].isnull(), 'count_prob_companies_closed_by_state'] = 0
